...
Version  : 0.23
Release  : 2
URL      : https://cran.r-project.org/src/contrib/admisc_0.23.tar.gz
Source0  : https://cran.r-project.org/src/contrib/admisc_0.23.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643043644

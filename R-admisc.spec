...
Version  : 0.27
Release  : 7
URL      : https://cran.r-project.org/src/contrib/admisc_0.27.tar.gz
Source0  : https://cran.r-project.org/src/contrib/admisc_0.27.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651524466

...
Version  : 0.34
Release  : 22
URL      : https://cran.r-project.org/src/contrib/admisc_0.34.tar.gz
Source0  : https://cran.r-project.org/src/contrib/admisc_0.34.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702274470

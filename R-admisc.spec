...
Version  : 0.22
Release  : 1
URL      : https://cran.r-project.org/src/contrib/admisc_0.22.tar.gz
Source0  : https://cran.r-project.org/src/contrib/admisc_0.22.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642092093

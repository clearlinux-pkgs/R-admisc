...
Version  : 0.28
Release  : 8
URL      : https://cran.r-project.org/src/contrib/admisc_0.28.tar.gz
Source0  : https://cran.r-project.org/src/contrib/admisc_0.28.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654612828
